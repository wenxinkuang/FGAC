...
from models.resnet_scas import ResNet18 as ResNet18_REG
from torch.autograd import Variable
from models.VGG16_scas import VGG16_REG
from models.wideresnet_scas import WideResNet
...
parser.add_argument('--beta', default=4.0, #4.0
                    help='regularization, i.e., 1/lambda in TRADES')
parser.add_argument('--seed', type=int, default=1, metavar='S',
                    help='random seed (default: 1)')
parser.add_argument('--log-interval', type=int, default=100, metavar='N',
                    help='how many batches to wait before logging training status')
parser.add_argument('--model-dir', default='./model-wideresnet1/2_scas-cifar10',
                    help='directory of model for saving checkpoint')
parser.add_argument('--save-freq', '-s', default=1, type=int, metavar='N',
                    help='save frequency')
parser.add_argument('--cr_beta', default=0.5,
...
def main():
    ...
    Smodel = ResNet18_REG(num_classes=10).to(device)
    print(model)
