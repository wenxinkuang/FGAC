...
from models.resnet import ResNet18 as ResNet18_REG
...
parser = argparse.ArgumentParser(description='PyTorch SVHN MART Defense')
...
parser.add_argument('--model', default='resnet18_mart_SVHN_2e-4wd_noscas',
...
def _pgd_whitebox(model,
    ...
    adv_output = model(X_pgd, _eval=True)
